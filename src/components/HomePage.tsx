...
export default function HomePage() {
  return (
    <div className="min-h-[calc(100vh-100px)] md:min-h-screen flex flex-col md:flex-row items-center justify-center bg-fixed bg-no-repeat bg-cover bg-center px-6 pt-16 pb-16 md:px-10 md:pt-24 md:pb-24 font-sans">
      <div className="flex flex-col md:flex-row items-center justify-center gap-2 md:gap-1">
        <div className="flex flex-col items-center md:items-start text-center md:text-left">
          ...
          <div className="w-full md:w-[30rem] text-slate-600 text-base md:text-lg mt-3 md:mt-6 md:text-left text-center">
        ...
        <div className="relative w-48 md:w-[25rem] h-48 md:h-[25rem] mt-3">
          <Image
